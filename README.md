...
## Legal Notice
This repository is proprietary. Usage requires **written approval** from TEOS Egypt / Elmahrosa International.  
Unauthorized use, reproduction, modification, or distribution is strictly prohibited.  
Public visibility does **not** imply open‑source status.

See [TESL.md](./TESL.md) and [LEGAL_APPENDIX.md](./LEGAL_APPENDIX.md) for full license terms.  
Contributors must sign [CLA.md](./CLA.md) before merging code.
